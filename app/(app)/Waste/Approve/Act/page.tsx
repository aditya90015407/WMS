        ...
        <div className="bg-white h-fit px-8 py-4 relative">
            ...
            <form onSubmit={handleSubmit} action="">
                <div className="grid grid-cols-2 text-sm">
                    <div className="px-2 py-2 font-semibold text-xs">Waste ID : <span className="font-normal text-sm"> {wasteData?.ID}</span></div>
                    ...
                    <div className="px-2 py-2 font-semibold text-xs col-span-2">Waste : <span className="font-normal text-sm"> {wasteData?.Waste}</span></div>
                    <div className="px-2 py-2 font-semibold text-xs">Waste Quantity : <span className="font-normal text-sm"> {wasteData?.WasteQty} {" "} {wasteData?.MUnit}</span></div>
