    ...
    <section className="max-w-5xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 space-x-10 mx-3 text-sm">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700">Waste Category</label>
            <select
              value={wasteCategory}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700">Total Quantity</label>
            <div
          ...
          {/* <div>
            <label className="block text-xs font-semibold text-slate-700">Document Proof</label>
            <input
              type="file"
