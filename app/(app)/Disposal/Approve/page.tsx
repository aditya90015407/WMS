    ...
    useEffect(() => {
        const loadRows = async () => {
            ...
            try {
                ...
                const res2 = await fetch(`/api/GetData/GetAllInitiatedDisposalList`, {
                    method: "POST",
                });
        ...
        <section className="max-w-4xl mx-auto rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div className="w-full">
                    <h1 className="text-lg text-center font-semibold text-slate-900"> Approve Initiated Disposal </h1>
                    <h1 className="text-sm text-center font-semibold text-slate-900"> Initiated Disposal List</h1>
