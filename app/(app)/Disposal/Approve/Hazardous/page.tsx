...
export default function DisposalApproveHazardousPage() {
    ...
    const saveDecision = async (stsCode: 3 | 5, label: "Accepted" | "Rejected") => {
        ...
        try {
            ...
            console.error("Failed to save disposal approval", error);
    ...
    return (
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900">Disposal Approval - Hazardous</h1>
                    <p className="mt-2 text-sm text-slate-600">Verify the submitted hazardous disposal form before taking action.</p>
                </div>
