...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const ccEmail = auctioneerMails

        // console.log(auctioneer, auctioneerMails)
        ...
        <p>Congratulations! Your bid for Auction ${IDDID} has been accepted, and the auction has been awarded to you.</p>

        <p><strong>Auction Details:</strong></p>
        <ul>
          <li>Auction ID : ${IDDID}</li>
          <li>Awarded On : ${generatedOn}</li>
        </ul>

       
        <p>Please log in to the Waste Management System and take necessary action.</p>
        ...
        const sendMail = await fetch(`https://jajitapps.jindalstainless.com:9234/api/AutoEmail/InstantEmailSend`, {
            ...
            body: JSON.stringify({
                "subject": `WMS : Auction Awarded_${IDDID}_Action Required`,
                "emailBody": mailBody,
