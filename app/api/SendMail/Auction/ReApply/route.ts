...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        <p>An application for Auction ${IDDID} reverted by you has been resubmitted by the vendor and is awaiting your review and approval.</p>
        ...
        <ul>
          ...
          <li>Submitted By : ${EmpName} (${EmpCode})</li>
