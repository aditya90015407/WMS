...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const getEnvAdminRes = await pool
            .request()
        ...
        // console.log(mailBodyonRejection)



        const mailBodyonApproval = `
        <p>Dear Environment Admin,</p>

        <p>An application for an Auction has been submitted and approved at Level 1. It is now awaiting your review and approval.</p>
