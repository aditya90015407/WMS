...
export async function POST(req: NextRequest) {
    ...
    var EmpCode = "", EmpName = "", WMSUnit = '', WMSDept = '';
    if (session) {
    ...
    try {
        ...
        var DisposedTo = ''
        if (AID == 1) {
            DisposedTo = "Internal Consumption"
        }
        else if (AID == 2) {
            DisposedTo = "Briquette Plant"
        }
        else if (AID == 3) {
            DisposedTo = "Civil (Internal)"
        }
        // console.log(body)
        ...
        <p>A new Disposal has been arranged for dispatch and is awaiting your review and approval.</p>
        ...
        <p>Please log in to WMS to review the dispatch request and take necessary action.</p>
        ...
        <ul>
          ...
          <li>Generated By : ${EmpName} (${WMSDept})</li>
          <li>Generated On : ${generatedOn}</li>
          <li>Disposed To : ${DisposedTo}</li>
        </ul>


        <p>Please log in to the Waste Management System to review the dispatch request and take necessary action.</p>
        <a href="https://jslaisrv01.jindalstainless.com:4433"> WMS </a>
        ...
        const sendMail = await fetch(`https://jajitapps.jindalstainless.com:9234/api/AutoEmail/InstantEmailSend`, {
            ...
            body: JSON.stringify({
                "subject": `WMS : New Disposal Generated_Action Required_${Waste}`,
                "emailBody": AID ? mailBodyforInternal : mailBody,
