...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        <p>The waste record generated by you has been reverted by ${EmpName}.</p>
        ...
        <ul>
          ...
          <li>Reverted On : ${revertedOn}</li>
          <li>Remarks : ${Remarks}</li>
        </ul>

        
        <p>Please log in to the Waste Manegement System to review the reverted waste and take necessary action.</p>
        ...
        const sendMail = await fetch(`https://jajitapps.jindalstainless.com:9234/api/AutoEmail/InstantEmailSend`, {
            ...
            body: JSON.stringify({
                "subject": `WMS : Waste Reverted_Action Required_${Waste}`,
                "emailBody": mailBody,
