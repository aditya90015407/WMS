...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const DisposerID = body.DID
        const Quantity = body.WasteQty
        ...
        // console.log(disposers, DisposerID, disposerMails, toEmail)
        ...
        <p>A waste record reverted by you has been updated and is awaiting your review and approval.</p>
        ...
        <p>Please log in to the Waste Management System to review the updated waste and take necessary action.</p>
        ...
        const sendMail = await fetch(`https://jajitapps.jindalstainless.com:9234/api/AutoEmail/InstantEmailSend`, {
            ...
            body: JSON.stringify({
                "subject": `WMS : Reverted Waste Updated_Action Required_${Waste}`,
                "emailBody": mailBody,
